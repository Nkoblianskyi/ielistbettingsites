    ...
    <section className="mb-6 md:mb-8 -mx-2 sm:-mx-4">
      <div className="rounded-b-2xl border border-slate-200 border-t-0 bg-white shadow-lg overflow-hidden">
        <div className="max-w-2xl mx-auto p-6 md:p-8 text-center">
          <p className="hidden md:block text-slate-500 text-xs font-semibold uppercase tracking-widest mb-2">
            Irish bookmakers
          </p>
          <h1 className="font-hero-display text-xl sm:text-3xl md:text-4xl font-extrabold text-slate-800 leading-tight tracking-tight">
            One list. <span className="text-slate-600">Ranked for you.</span>
          </h1>
          <p className="mt-3 text-xs md:text-sm text-slate-500 flex items-center justify-center gap-2">
            <Calendar className="h-4 w-4 text-slate-400 shrink-0" />
            <time dateTime={dateISO}>{dateLabel}</time>
          </p>
          <p className="mt-4 text-slate-600 text-xs md:text-sm leading-relaxed">
          ...
          <div className="mt-6 flex flex-col items-center gap-4">
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-stretch justify-center gap-3">
              ...
              <div className="hidden  sm:inline-flex items-center gap-2 rounded-xl bg-slate-50 border border-slate-200 px-3 py-2.5 min-w-0">
